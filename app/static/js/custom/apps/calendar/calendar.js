...
var KTAppCalendar = function () {
    ...
    const x = () => {
        ...
        D.addEventListener("click", (function (o) {
                ...
                p && p.validate().then((function (o) {
                        ...
                        "Valid" == o ? (D.setAttribute("data-kt-indicator", "on"), D.disabled = !0, setTimeout((function () {
    ...
    B = () => {
        ...
        n;
        w.show(),
        M.allDay ? (e = "All Day", t = moment(M.startDate).format("Do MMM, YYYY"), n = moment(M.endDate).format("Do MMM, YYYY")) : (e = "", t = moment(M.startDate).format("Do MMM, YYYY - h:mm a"), n = moment(M.endDate).format("Do MMM, YYYY - h:mm a")),
